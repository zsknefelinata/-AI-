...
export const diseaseDist = [
  { type: 'transverse' as const, name: '横向裂缝', count: 28 },
  { type: 'longitudinal' as const, name: '纵向裂缝', count: 24 },
  { type: 'alligator' as const, name: '龟裂', count: 19 },
  { type: 'pothole' as const, name: '坑槽', count: 15 }
]

export const routeDist = [
...
export const taskFlows: TaskFlow[] = [
  ...
  { time: '2026-09-02 09:30', event: '启动识别', operator: '系统', description: '进入 AI 识别流水线（模型训练中）' },
